import { statusVedeurService } from './../../../statusVedeur/services/service.service';
...
export class FormComponent implements OnInit {
  ...
  message;
  constructor(
    private statusVedeurService: statusVedeurService,
  ...
  create(){
    ...
    this.isLoad = true
     ...
     this.statusVedeurService.create(this.statusVedeur).subscribe(res=>{
        if(res){

            this.redirect.redirectTostatusVedeur()
  ...
  getEdit(id){
    this.statusVedeurService.search({_id:id}).subscribe(res=>{
      if(res)this.statusVedeur =res[0];
